...
function addEmotion(msg, name) {
    if(currentUser != name) {
      if(msg.contains("Joy")) { // happy 
        ...
        $("#chatEntries").append('<div class="messageSelf"><p>' + name + ' ' + msg + '</p></div> <div class="clear"></div>' + '<div class="emotionSelf"><a href="http://www.freesmileys.org/smileys.php"><img src="http://www.freesmileys.org/smileys/smiley-sick006.gif"></a></div>');
      ...
      if(msg.contains("Joy")) { // happy 
        ...
        $("#chatEntries").append('<div class="messageSelf"><p>' + name + ' ' + msg + '</p></div> <div class="clear"></div>' + '<a href="http://www.freesmileys.org/smileys.php" title="Smiley"><img src="http://www.freesmileys.org/smileys/smiley-sick006.gif"></a></div>');
        // $("#chatEntries").append('<div class="messageSelf"><p>' + name + ' ' + msg + '</p></div> <div class="clear"></div>' + '<div class="emotionSelf"><a href="http://www.sherv.net/"><img alt="3D smiley full of anger" src="http://www.sherv.net/cm/emo/angry/3d-mad.gif"></a></div>');
      }
    }
